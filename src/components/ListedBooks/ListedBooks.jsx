      ...
      <Tabs>
        ...
        <TabPanel>
          <div className="space-y-6 mt-8">
            {booksList.map((book) => (
              <div className="flex flex-col md:flex-row justify-center gap-6 border border-[#13131326] rounded-2xl p-6">
                {/* image div */}
                ...
                <div className="md:w-4/5 space-y-4">
                  <h2 className="text-2xl font-medium text-center md:text-left">{book.bookName}</h2>
                  <h2 className="text-center md:text-left">By : {book.author}</h2>
                  <div className="flex flex-col md:flex-row justify-start items-center gap-4">
                    <span className="text-sm font-bold text-center md:text-left">Tag: </span>
